 ...
 * @author Spedwards
 */
export default class SVGSpawn extends SVG {
	private spawn: Spawn;
	 ...
	 */
	constructor(spawn: Spawn, protected size: number = 40) {
		super();
	...
	static getSVG(spawn: Spawn, size?: number): string {
		return new SVGSpawn(spawn, size).toString();
	}
}