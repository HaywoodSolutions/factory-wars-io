 ...
 * @author Spedwards
 */
export default class SVGNuker extends SVG {
	/**
	 * @author Spedwards
	 ...
	 */
	constructor(private nuker: Nuker, protected size: number = 60) {
		super();
	...
	static getSVG(nuker: Nuker, size?: number): string {
		return new SVGNuker(nuker, size).toString();
	}
};
