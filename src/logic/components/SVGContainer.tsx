 ...
 * @author Spedwards
 */
export default class SVGContainer extends SVGStorageObject {
	 ...
	 */
	constructor(container: StorageObject, protected size: number = 35) {
	...
	render() {
		...
		return  (
			<svg height={SVG_SIZE} width={SVG_SIZE * (5/6)} viewBox="0 0 50 80">
	...
	static getSVG(terminal: StorageObject, size?: number) {
		return new SVGContainer(terminal, size).toString();
	}
}
